	...
	<section id="three-col" class="row equal">
	    <div class="col-md-4 col serve">
		    ...
		    <div style="padding: 0 25px">
				...
				<ul>
					<li><!-- <img class="clear size-full wp-image-164" src="http://ashley-cameron.com/clients/auromedics/wordpress/wp-content/uploads/icon-hospital.png" alt="icon hospital" width="47" height="47"> -->Health System Customers</li>
	    ...
	    <div class="col-md-4 col catalog">
	    ...
	    <div class="col-md-4 col subscribe">
